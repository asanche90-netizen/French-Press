...
function waterOptionsFor(unit: Unit): DrawerOption<WaterPreset>[] {
  ...
  return [
    { value: "small", label: "Small", secondary: `1 cup · ${size(250)}` },
    { value: "medium", label: "Medium", secondary: `2 cups · ${size(350)}` },
    { value: "large", label: "Large", secondary: `3 cups · ${size(500)}` },
  ];
}
...
export default function HomeDrip({
  method,
  waterMl,
  roast,
  strength,
      ...
      <div className="mx-auto flex min-h-dvh max-w-[480px] flex-col px-5">
        ...
        <main className="flex flex-col gap-4">
          ...
          <section className="flex flex-col gap-1 pb-2">
            ...
            <OutputRow
              label="Brew time"
              primary={formatTime(recipe.brewSec)}
              primaryUnit=""
              mono
            />
          </section>
          ...
          <p className="px-1 text-xs text-muted">
            Use a medium grind, like sea salt.
          </p>
